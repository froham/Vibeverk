  ...
  function imageField(opts) {
    ...
    return `
      <div class="field imgfield" data-imgfield>
        ...
        <div class="imgfield__preview" data-imgfield-preview data-aspect="${aspect}" tabindex="0" role="slider" aria-label="Fokuspunkt for utsnitt — bruk piltastene for å flytte" aria-valuemin="0" aria-valuemax="100" aria-valuenow="50" aria-valuetext="Midten"></div>
