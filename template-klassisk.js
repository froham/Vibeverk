/* =============================================================================
   ...
   (her: content.hero.title). Berre denne EINE nøkkelen er lagt til enno,
   medvite -- kvar ny nøkkel krev både (1) attributtet her og (2) ei
   oppføring i LIVE_EDIT_FIELDS-kvitelista i core.js, elles vert klikket
   ignorert. ALDRI legg attributtet på eit element utan ekte innhaldsfelt
   bak (t.d. reint dekorative/hardkoda element) -- sjå Architect-vurderinga
   om kvifor template-vibeverk-cinema.js sitt "tre grunnar"-band og
   terminal-animasjon MÅ haldast utanfor dette heilt.
   ========================================================================== */
(function () {
  "use strict";
