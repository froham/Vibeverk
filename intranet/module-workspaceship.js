/* =============================================================================
   ...
   Standalone Intranet module. Vanilla JS, no dependencies.
   ============================================================================= */
(function () {
  "use strict";
  ...
  var App = window.App;
  if (!Intranet || !App || !App.store) return;
  ...
  function render() {
    return '<div id="workspaceship-root" class="wsp-root"></div>';
  }
  ...
  function startGame(root) {
    ...
    function onKeyDown(event) {
      ...
      if (event.key === "Escape" && root.classList.contains("ws-immersive")) leaveFullscreen();
    }
