...
| [ADR-0015](ADR-0015-agent-tool-access-policy.md) | AI/agent access to customer systems must always go through a Vibeverk-controlled tool, never direct DB/secret access | Accepted |
