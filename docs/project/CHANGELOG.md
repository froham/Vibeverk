...
Fire brukarpresiserte korreksjonar til rollemodell/CRM/tasks/e-post-flyten frå tidlegare same dag, implementert som éin samla runde ("avklarte krav — uten ny produktutredning"). Ingen av SQL-hotfixane er køyrt mot produksjon enno; ingen `git push`.
