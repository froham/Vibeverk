...
Dette dokumentet beskriver v0.151.2-releasekandidaten. Det er ikke gjort noen databasemigrasjon eller produksjonsutrulling. Produksjonsgrensesnittet returnerer fortsatt bevisst `not_configured`/`gateway_not_configured` for drift og kommandoer; den eneste nye forbindelsen er en eksplisitt, lokal browser-bro til AI Lab/Gemma.
